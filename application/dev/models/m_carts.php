...
class M_carts extends MM_Model {
  ...
  function reachedMOQ() {
	...
	if (!$this->productsID || !$this->qtyTotal)
	  return false;
  ...
  function calculateTotals() {
	...
	foreach ($prices as $price) {
	  ...
	  if ($this->qtyTotal >= $price->metaKey)
	...
	// Minimum charge
	if ($freightTotal < $freightTable->minCharge)
	  $freightTotal = $freightTable->minCharge;
